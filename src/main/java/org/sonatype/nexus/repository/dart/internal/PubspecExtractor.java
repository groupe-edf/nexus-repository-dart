...
public class PubspecExtractor extends ComponentSupport {
    ...
    /**
     * Extracts the contents for the first matching {@code composer.json} file (of
    ...
    /**
     * Processes a single entry in the archive. If the entry is the composer.json
     * then the attributes will be extracted. If not, the entry is skipped.
     */
    ...
    /**
     * Returns a boolean indicating if the associated file path (from an archive
